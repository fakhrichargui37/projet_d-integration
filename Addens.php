...
<div class="container">
      <div class="heading">
        <h2> <center>Liste des enseignants </center></h2>
        <hr>
      </div>
      <table class="table" id="example">
        ...
        foreach ($lesens as $i) {
            ...
            <td>$i[0]</td>
            <td>$i[1]</td>    
            <td><i style='cursor:pointer' class='far fa-eye' data-toggle='modal' data-target='#exampleModal' onclick='setid()' ></i>
            <i style='cursor:pointer' class='far fa-eye' data-toggle='modal' data-target='#exampleModal' onclick='setid()' ></i></td>
          </tr>"; 
        }
        ?>
        </tbody>
      </table>
      <center><a href="../view/insertAppartement.php" style='cursor:pointer' data-toggle='modal' data-target='#exampleModal' class="btn btn-primary btn-sm">Ajouter un Appartement</a></center>
    </div>
  </div>
<!-- Modal -->
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer justify-content-between">
        <center><button type="button" id="btn1"  class="btn btn-success" data-dismiss="modal">Enregister</button></center>
      </div>
    </div>
  </div>
</div>
